<template>
  <div class="content">
    ...
    <!--    <div
            v-if="$route.params.catalogItem === 'kaffs'"
    ...
    <main
        ...
        :style="[$route.params.catalogItem !== 'constructor' /* && $route.params.catalogItem !== 'kaffs' */ ? {marginTop : this.$store.state.slider.header_height + 'px'} : {marginTop : 0}]"
    >
      <div class="top-menu">
        <MenuItems
