<template>
  <div class="callback">
    ...
    <div class="title">
      <h1>
        Все интересующие вас вопросы можно уточнить:
      </h1>
      <p>
        WhatsApp<br>
        <a href="https://api.whatsapp.com/send?phone=79066345690" target="_blank">+7 (906) 634-56-90</a>
      </p>
      <p>
        E-Mail<br>
